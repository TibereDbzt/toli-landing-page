/* Toli landing — Lucide-style line icons (2px stroke, round caps/joins).
   Exposed as window.Icons. Mirrors lucide; matches the Toli product chrome. */
(function () {
  ...
  const I = {
    ...
    list: (p = {}) => Svg(p, [
      h("line", { key: 1, x1: 8, y1: 6, x2: 21, y2: 6 }), h("line", { key: 2, x1: 8, y1: 12, x2: 21, y2: 12 }), h("line", { key: 3, x1: 8, y1: 18, x2: 21, y2: 18 }),
      h("circle", { key: 4, cx: 3.5, cy: 6, r: 1 }), h("circle", { key: 5, cx: 3.5, cy: 12, r: 1 }), h("circle", { key: 6, cx: 3.5, cy: 18, r: 1 }),
    ]),
