...
import { Avatar, RegistrationPill, Button, Tag } from '../lib/ds.js'
...
export function AthleteRegMock() {
  const events = [
  ...
  return (
    <Phone label="races">
      <div style={{ padding: '10px 18px 18px', height: 470, overflow: 'hidden' }}>
        <div style={{ fontFamily: 'var(--font-ui)', fontSize: 10, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--text-muted)' }}>Anaïs Roussel</div>
        ...
        <div style={{ marginTop: 16 }}>
          <Button size="sm" style={{ width: '100%' }} icon={<Ic.check size={15} />}>Update my status</Button>
        </div>
      </div>
    </Phone>
  )
...
export function AthleteInboxMock() {
  const msgs = [
  ...
  return (
    <Phone label="inbox">
      <div style={{ padding: '10px 18px 18px', height: 470, overflow: 'hidden' }}>
        <div style={{ fontFamily: 'var(--font-ui)', fontSize: 10, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--text-muted)' }}>2 unread</div>
