...
import { Avatar, Tag, StatusDot, RegistrationPill, StatCard, Metric, Button } from '../lib/ds.js'
import { Rail, Eyebrow, Flag, Win, Fit } from './shell.jsx'
  ...
  return (
    <div style={{ display: 'flex', background: 'var(--surface-app)', minHeight: 540 }}>
      ...
      <div style={{ flex: 1, padding: '26px 30px 10px' }}>
        <Eyebrow style={{ color: 'var(--text-muted)' }}>Roster · 18 athletes</Eyebrow>
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginTop: 6 }}>
          ...
          <Button size="sm" icon={<Ic.plus size={16} />}>Add athlete</Button>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: cols, gap: 16, padding: '0 4px 12px', borderBottom: '1px solid var(--hairline)' }}>
          {['Athlete', 'Status', 'Category', 'UTMB index', 'Races', 'Country'].map((h) => <Eyebrow key={h}>{h}</Eyebrow>)}
        </div>
    ...
    <div style={{ background: 'var(--surface-card)', border: '1px solid var(--hairline)', borderRadius: 16, padding: 18, boxShadow: 'var(--shadow-card)' }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
        <div style={{ display: 'flex', gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 6 }}><Flag label={a.c} /></div>
          </div>
        </div>
      ...
      {a.note ? (
        <div style={{ marginTop: 14, background: 'var(--surface-well)', borderRadius: 12, padding: '11px 13px' }}>
          <Eyebrow style={{ fontSize: 10, color: 'var(--danger)' }}>Note</Eyebrow>
    ...
    <div style={{ display: 'flex', background: 'var(--surface-app)', minHeight: 560 }}>
      ...
      <div style={{ flex: 1, padding: '24px 30px 30px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          ...
          <Button variant="secondary" size="sm" icon={<Ic.share size={15} />}>Share</Button>
        </div>
        ...
        <div style={{ marginTop: 26 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
            ...
            <span style={{ marginLeft: 'auto' }}><Eyebrow>4 entered</Eyebrow></span>
          </div>
...
export function RegMock() {
  ...
  return (
    <div style={{ background: 'var(--surface-app)', padding: '26px 30px', minHeight: 520 }}>
      <Eyebrow style={{ color: 'var(--text-muted)' }}>UTMB · Registrations</Eyebrow>
